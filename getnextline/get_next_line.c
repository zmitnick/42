...
/*   Updated: 2015/02/02 18:42:49 by mstephan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_match_fd(t_info **list, t_info **cur, int const fd)
{
	t_info		*temp;
...
void			ft_del_fd(t_info **list, t_info *cur)
{
	t_info		*temp;
...
int				ft_realloc(char **line, char *buf, int size, int *len)
{
	char		*temp;
